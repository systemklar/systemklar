...
const STYLE_H2 =
  "margin:0 0 16px 0;font-size:22px;font-weight:700;color:#0A1628;font-family:'DM Sans',Arial,sans-serif;";
const STYLE_P =
  "margin:0 0 12px 0;font-size:15px;color:#2A4868;line-height:1.6;font-family:Arial,sans-serif;";
const STYLE_P_LAST =
  "margin:0 0 20px 0;font-size:15px;color:#2A4868;line-height:1.6;font-family:Arial,sans-serif;";
const STYLE_P_INFO =
  "margin:0 0 8px 0;font-size:14px;color:#2A4868;line-height:1.6;font-family:Arial,sans-serif;";
const STYLE_P_HELP =
  "margin:16px 0 0 0;font-size:13px;color:#2A4868;line-height:1.6;font-family:Arial,sans-serif;";
const STYLE_STRONG_DARK = "color:#0A1628;";
const STYLE_LINK = "color:#2952A3;text-decoration:none;";
const STYLE_QUOTE =
  "background:#E8EEFC;border-left:3px solid #2952A3;padding:12px 16px;border-radius:0 8px 8px 0;margin:16px 0;color:#2A4868;font-size:14px;line-height:1.6;font-family:Arial,sans-serif;";
...
<p style="margin:0 0 20px 0;font-size:14px;color:#2A4868;line-height:1.6;font-family:Arial,sans-serif;"><strong style="${STYLE_STRONG_DARK}">Emne:</strong> {{ticketTitle}}</p>
{{adminButton}}`,
...
<p style="margin:16px 0 8px 0;font-size:14px;color:#2A4868;font-family:Arial,sans-serif;"><strong style="${STYLE_STRONG_DARK}">Besked:</strong></p>
