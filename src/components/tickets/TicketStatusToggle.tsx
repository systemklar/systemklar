  ...
  return (
    <div className="flex flex-col items-end gap-2 sm:flex-row sm:items-center">
      ...
      <button
        ...
        className="rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
      >
        {busy
          ? "Opdaterer..."
          : current === "active"
