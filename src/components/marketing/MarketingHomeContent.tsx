...
export function MarketingHomeContent() {
  ...
  const stepCardClass = (active: boolean, pulse = true) =>
    `relative flex flex-col items-start rounded-2xl p-4 text-left transition-all duration-200 ${
      active
        ? `border border-[#4A7FA5]/50 bg-[#4A7FA5]/20 ring-1 ring-[#4A7FA5]/30${pulse ? " animate-pulse" : ""}`
  ...
  return (
    <main className="flex flex-col">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden border-t border-black/5 bg-gradient-to-br from-[#4A7FA5] to-[#1E3448] py-0">
        <div
          ...
          <AnimatedSection direction="up" delay={200}>
            <div className="flex w-full flex-col items-stretch justify-center gap-3 sm:inline-flex sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
              <button
                ...
                className="min-h-[44px] rounded-full bg-white px-8 py-4 text-base font-semibold text-[#4A7FA5] transition-all hover:bg-white/90"
              >
      ...
      <section className="relative z-10 border-t border-black/5 bg-[#EAF1F7] py-16 md:py-24">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <h2 className="mb-3 text-2xl font-bold tracking-tight text-[#1E3448] md:text-3xl">
            Alt på ét sted – præcis som det er
          </h2>
          <p className="mx-auto mb-6 max-w-2xl text-base text-[#4A6478] md:text-lg">
            Se hvordan platformen ser ud i praksis – med et overblik du kan forstå med det samme.
          </p>
        </div>
        <div className="mx-auto max-w-2xl px-6">
          <AnimatedSection direction="up">
            <div className="hidden overflow-hidden rounded-2xl border border-[#C8D8E4] bg-white shadow-md md:block">
              <div className="flex items-center gap-2 border-b border-[#C8D8E4] bg-[#EAF1F7] px-3 py-2">
                <div className="flex gap-1">
                  <div className="h-2.5 w-2.5 rounded-full bg-red-400" />
                  <div className="h-2.5 w-2.5 rounded-full bg-amber-400" />
                  <div className="h-2.5 w-2.5 rounded-full bg-green-400" />
                </div>
                <div className="flex-1 rounded-full bg-white px-3 py-0.5 text-[10px] text-[#4A6478]">
                  systemklar.dk/portal
                </div>
              </div>
              <div className="p-3">
                <div className="mb-3 flex gap-1 rounded-lg bg-[#EAF1F7] p-1">
                  {(["Overblik", "Support", "IT-rapport"] as TabKey[]).map((tab) => (
                    <button
                      ...
                      className={`flex-1 rounded-md px-2 py-1 text-xs font-medium transition-all duration-200 ${
                        activeTab === tab ? "bg-white text-[#3A6F95] shadow-sm" : "text-[#4A6478] hover:text-[#3A6F95]"
                      }`}
                    >
                      {tab}
                    </button>
                ...
                <div className={`transition-opacity duration-300 ${changing ? "opacity-0" : "opacity-100"}`}>
                  {activeTab === "Overblik" ? (
                    <div className="flex" style={{ height: "220px" }}>
                      <div className="flex w-32 flex-col gap-1 border-r border-[#E0EAF0] bg-[#F7F4EF] p-2.5">
                        <div className="mb-1 text-[10px] font-bold text-[#4A7FA5]">systemklar</div>
                        <div className="rounded-md bg-[#EAF1F7] px-2 py-1 text-[10px] font-medium text-[#3A6F95]">
                          Overblik
                        </div>
                      ...
                      <div className="flex-1 bg-white p-3">
                        <div className="mb-0.5 text-xs font-bold text-[#1E3448]">Goddag, Møllers VVS</div>
                        <div className="mb-2 text-[10px] text-[#4A6478]">Her er dagens overblik.</div>
                        <div className="grid grid-cols-3 gap-1.5">
                          <div className="rounded-md bg-[#EAF1F7] p-1.5 text-center">
                            <div className="text-xs font-bold text-[#4A7FA5]">3</div>
                            <div className="text-[9px] text-[#4A6478]">Systemer OK</div>
                          </div>
                          <div className="rounded-md bg-[#EAF1F7] p-1.5 text-center">
                            <div className="text-xs font-bold text-[#4A7FA5]">1</div>
                            <div className="text-[9px] text-[#4A6478]">Åben sag</div>
                          </div>
                          <div className="rounded-md bg-[#EAF1F7] p-1.5 text-center">
                            <div className="text-xs font-bold text-[#4A7FA5]">apr</div>
                            <div className="text-[9px] text-[#4A6478]">Rapport</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {activeTab === "Support" ? (
                    <div style={{ height: "220px" }} className="p-1">
                      <div className="mb-2 text-xs font-bold text-[#1E3448]">Support &amp; sager</div>
                      <div className="flex flex-col gap-1.5">
                        <div className="max-w-[80%] self-end rounded-2xl rounded-tr-sm bg-[#4A7FA5] px-2.5 py-1.5 text-[10px] text-white">
                          Vores printer printer ikke – det haster lidt
                        </div>
                        <div className="max-w-[80%] self-start rounded-2xl rounded-tl-sm bg-[#EAF1F7] px-2.5 py-1.5 text-[10px] text-[#4A6478]">
                  ...
                  {activeTab === "IT-rapport" ? (
                    <div style={{ height: "220px" }} className="p-1">
                      <div className="text-xs font-bold text-[#1E3448]">IT-rapport – april 2026</div>
                      <div className="mb-2 text-[10px] text-[#4A6478]">Møllers VVS</div>
                      <div className="grid grid-cols-3 gap-1.5">
                        ...
                        <div className="rounded-md bg-[#EAF1F7] p-1.5 text-center">
                          <div className="text-xs font-bold text-[#4A7FA5]">3</div>
                          <div className="text-[9px] text-[#4A6478]">Løste sager</div>
                        </div>
                        <div className="rounded-md bg-[#EAF1F7] p-1.5 text-center">
                          <div className="text-xs font-bold text-[#4A7FA5]">0</div>
                          <div className="text-[9px] text-[#4A6478]">Åbne sager</div>
                        </div>
                      </div>
                    </div>
                  ) : null}
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            {featurePills.map((feature, i) => (
              <span
                key={feature}
                className="rounded-full border border-[#C8D8E4] bg-white px-3 py-1 text-xs font-medium text-[#3A6F95] shadow-sm"
          ...
          <div className="mt-8 text-center">
            <Link
              href="/platformen"
              className="inline-flex items-center gap-2 text-sm font-medium text-[#4A7FA5] transition-colors hover:text-[#3A6F95]"
            >
      ...
      <section id="roi-beregner" className="relative z-10 bg-white py-16 md:py-24">
        <div className="mb-12 px-6 text-center">
          <span className="inline-flex items-center rounded-full border border-[#C8D8E4] bg-[#EAF1F7] px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-[#3A6F95]">
            Gratis beregner
          </span>
          <h2 className="mb-3 mt-4 text-2xl font-extrabold text-[#1E3448] md:text-4xl">
            Hvad koster IT-rod
            <br />
            din virksomhed?
          </h2>
          <p className="mx-auto max-w-lg text-base text-[#4A6478]">
            Besvar 6 spørgsmål og få et præcist svar på hvad IT-rod koster jer.
          </p>
        </div>
        <div className="mx-auto max-w-2xl px-4 md:px-6">
          <div className="rounded-3xl bg-gradient-to-br from-[#4A7FA5]/20 to-[#1E3448]/40 p-[1px]">
              ...
              <div className="relative min-h-[420px]">
                ...
                >
                  ...
                  <div className="cvr-dropdown-wrapper relative">
                    <input
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-white/5 px-5 py-4 pr-12 text-sm text-white outline-none placeholder:text-white/30 focus:border-[#4A7FA5]/50"
                    />
                    {cvrLoading ? (
                  ...
                  {cvrData && !showDropdown ? (
                    <div className="mt-3 flex items-center gap-3 rounded-2xl border border-[#4A7FA5]/20 bg-[#4A7FA5]/10 px-5 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {employeeOptions.map((option) => {
                      ...
                      return (
                        ...
                        >
                          {active && cvrData ? (
                            <span className="absolute -top-2 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-[#4A7FA5]/30 bg-[#4A7FA5]/30 px-2 py-0.5 text-[9px] font-semibold text-[#A8C8E0]">
                              Fra CVR
                            </span>
                          ) : null}
                          <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-xl bg-white/10">
                            <Users className={`h-4 w-4 ${active ? "text-[#A8C8E0]" : "text-white/70"}`} />
                          </div>
                          <p
                            className={`text-sm font-semibold ${active ? "text-[#A8C8E0]" : "text-white"}`}
                          >
                            {option.label}
                          </p>
                        </button>
                    ...
                    {industryOptions.map((option) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-xl bg-white/10">
                            <Icon className={`h-4 w-4 ${active ? "text-[#A8C8E0]" : "text-white/70"}`} />
                          </div>
                          <p
                            className={`text-sm font-semibold ${active ? "text-[#A8C8E0]" : "text-white"}`}
                          >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {wasteOptions.map((option) => {
                      ...
                      return (
                        ...
                        >
                          <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-xl bg-white/10">
                            <Icon className={`h-4 w-4 ${selected ? "text-[#A8C8E0]" : "text-white/70"}`} />
                          </div>
                          <p
                            className={`text-sm font-semibold ${selected ? "text-[#A8C8E0]" : "text-white"}`}
                          >
                            {option.title}
                          </p>
                          <p className="mt-0.5 text-xs text-white/40">{option.subtitle}</p>
                  ...
                  <button
                    ...
                    className="mt-4 w-full rounded-2xl bg-[#4A7FA5] py-4 font-semibold text-white transition-all hover:bg-[#4A7FA5] disabled:cursor-not-allowed disabled:opacity-30"
                  >
                    Beregn resultat
                  </button>
                </div>
                ...
                >
                  <AnimatedSection direction="up">
                      ...
                      <div className="mb-4 rounded-2xl border border-white/10 bg-white/5 p-4 text-left">
                        ...
                        <ul className="space-y-2 text-[11px] leading-relaxed text-white/50">
                          <li className="flex items-start gap-1.5">
                            <span className="mt-0.5 flex-shrink-0 text-[#E8D8C4]">·</span>
                            <span>
                    ...
                    <Link
                      href="/kontakt"
                      className="mt-5 block w-full rounded-2xl bg-[#4A7FA5] py-4 text-center text-sm font-semibold text-white transition-all hover:bg-[#4A7FA5]"
                    >
                      Book en gratis demo
                    </Link>
      ...
      <section className="relative z-10 border-t border-black/5 bg-[#1E3448] py-16 md:py-24">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-[#A8C8E0]">Hvad kunderne siger</p>
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 px-6 md:grid-cols-3 md:gap-8">
          <div className="flex flex-col justify-between rounded-2xl border border-white/10 bg-white/5 p-6 text-white md:col-span-2 md:p-8">
            ...
            <div className="flex items-center gap-3 border-t border-white/10 pt-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#4A7FA5] text-xs font-bold text-white">
      ...
      <section className="relative z-10 border-t border-black/5 bg-[#EAF1F7] py-16 md:py-24">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <h2 className="mb-3 text-2xl font-bold tracking-tight text-[#1E3448] md:text-3xl">Priser</h2>
          <p className="mx-auto mb-6 max-w-2xl text-base text-[#4A6478] md:text-lg">
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-6 flex min-h-8 items-center justify-center gap-3">
            <span className={`text-sm font-medium ${!yearly ? "text-[#1E3448]" : "text-[#4A6478]"}`}>Månedlig</span>
            <button
            ...
            <span className={`text-sm font-medium ${yearly ? "text-[#1E3448]" : "text-[#4A6478]"}`}>Årlig</span>
            <span
            ...
            {homePlans.map((priceCard, index) => (
              ...
              >
                <div className="relative h-full">
                  {priceCard.highlight ? (
                    <div
                      className="pointer-events-none absolute -inset-0.5 animate-pulse rounded-[18px] bg-[#4A7FA5]/30 blur-sm"
                      aria-hidden
                    />
                  ) : null}
                  <article
                    className={`relative flex h-full flex-col rounded-2xl bg-white p-8 ${
                      priceCard.highlight
                        ? "border-2 border-[#3A6F95] shadow-md"
                        : "border border-[#C8D8E4] shadow-sm"
                    }`}
                  >
                    <p className="text-xs font-semibold uppercase tracking-wide text-[#4A6478]">{priceCard.name}</p>
                    <p
                      className={`mt-2 text-3xl font-bold text-[#1E3448] transition-opacity duration-200 ${
                        priceFading ? "opacity-0" : "opacity-100"
                      }`}
                    >
                      {yearly ? priceCard.yearly : priceCard.monthly}
                    </p>
                    {yearly ? <p className="mt-0.5 text-[10px] text-[#4A6478]">faktureres årligt</p> : null}
                    <p className="mt-2 text-[10px] text-[#4A6478]">{priceCard.fits}</p>
                    <ul className="mt-4 flex-1 space-y-3 text-base text-[#4A6478]">
                      {priceCard.features.map((feature) => (
                        <li key={feature} className="flex items-start gap-2">
                          <CheckCircle className="mt-1 h-4 w-4 shrink-0 text-[#4A7FA5]" />
                          <span>{feature}</span>
                        </li>
                      ))}
                    </ul>
                    <Link
                      ...
                      className={`mt-4 inline-flex w-full justify-center rounded-full px-5 py-2 text-sm font-semibold transition-colors ${
                        priceCard.highlight
                          ...
                          : "border border-[#C8D8E4] text-[#3A6F95] hover:bg-[#EAF1F7]"
                      }`}
                    >
                      Vælg {priceCard.name}
                    </Link>
          ...
          <div className="mt-6 text-center">
            <Link href="/priser" className="text-xs font-semibold text-[#4A7FA5] hover:text-[#3A6F95]">
              Se alle features →
            </Link>
            <p className="mt-2 text-[10px] text-[#4A6478]">
      ...
      <section
        id="cta"
        className="relative z-10 border-t border-black/5 bg-[#1E3448] py-16 md:py-24"
      >
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={() => setShowDemoModal(true)}
              className="min-h-[44px] rounded-full bg-[#4A7FA5] px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#4A7FA5]"
            >
              Book en gratis snak
            </button>
          </div>
