...
export function MarketingFooter() {
  ...
  return (
    <footer className="border-t-2 border-[#162A3A]/80 bg-[#162A3A] text-sm text-[#EAF1F7]">
      <div className="mx-auto grid max-w-5xl gap-10 px-6 py-16 md:grid-cols-2 md:gap-12 md:py-24 lg:grid-cols-4">
        <div className="md:col-span-2 lg:col-span-1">
          ...
          <p className="mt-4 leading-relaxed text-[#A8C8E0]">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3">
            ...
            <li>
              <Link href="/privatlivspolitik" className="text-[#7A9AB0] text-sm transition-colors hover:text-white">
                Privatlivspolitik
              </Link>
            </li>
            <li>
              <Link href="/cookiepolitik" className="text-[#7A9AB0] text-sm transition-colors hover:text-white">
                Cookiepolitik
              </Link>
            </li>
            <li>
              <Link href="/vilkaar" className="text-[#7A9AB0] text-sm transition-colors hover:text-white">
                Vilkår
              </Link>
            </li>
            <li>
              <Link href="/databehandleraftale" className="text-[#7A9AB0] text-sm transition-colors hover:text-white">
                Databehandleraftale
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-[#162A3A]/60">
        <p className="mx-auto max-w-5xl px-6 py-6 text-[#A8C8E0]">
