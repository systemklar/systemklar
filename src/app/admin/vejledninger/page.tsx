...
function typeBadgeClasses(t: GuideRow["type"]): string {
  if (t === "video") return "bg-sky-100 text-sky-800 border border-sky-200";
  if (t === "faq") return "bg-purple-100 text-purple-900 border border-purple-200";
  return "bg-emerald-100 text-emerald-900 border border-emerald-200";
}

export default function AdminVejledningerPage() {
  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#0D1F2D] md:text-3xl">Vejledninger &amp; FAQ</h1>
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          <div className="w-full shrink-0 lg:w-1/3">
            <nav className="space-y-2 rounded-2xl border border-sky-100 bg-white p-3 shadow-sm">
              ...
              >
                <span className="font-semibold text-[#0D1F2D]">Alle</span>
              </button>
              {categories.map((c) => {
              ...
              <button
                ...
                className="mt-2 w-full rounded-xl border border-dashed border-sky-200 py-2 text-sm font-medium text-sky-700 hover:bg-sky-50"
              >
                Ny kategori
              </button>
            </nav>
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0 space-y-2">
                      ...
                      <h2 className="text-lg font-semibold text-[#0D1F2D]">{g.title}</h2>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog">
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-sky-100 bg-white p-6 shadow-xl">
            ...
            <div className="mt-4 space-y-3">
              <div>
                <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Titel</label>
                <input
                  value={gTitle}
              ...
              <div>
                <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Type</label>
                <select
                  value={gType}
              ...
              <div>
                <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Kategori</label>
                <select
                  value={gCategoryId}
              ...
              {gType === "video" ? (
                <div>
                  <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Video-URL (YouTube / Vimeo)</label>
                  <input
                    value={gVideoUrl}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={10}
                    className="w-full rounded-xl border border-sky-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
                  />
                </div>
              )}
      ...
      {categoryModalOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog">
          <div className="w-full max-w-md rounded-2xl border border-sky-100 bg-white p-6 shadow-xl">
            <h2 className="text-lg font-semibold text-[#0D1F2D]">Ny kategori</h2>
            <div className="mt-4 space-y-3">
              <div>
                <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Navn</label>
                <input
                  value={cName}
              ...
              <div>
                <label className="mb-1 block text-sm font-medium text-[#0D1F2D]">Ikon</label>
                <select
                  value={cIcon}
