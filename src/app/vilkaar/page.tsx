      ...
      <main>
        <section className="bg-[#EEF2E6] py-20">
          <div className="mx-auto max-w-3xl px-6 text-center">
            <h1 className="text-4xl font-bold text-[#2C3020]">Vilkår og betingelser</h1>
            <p className="mt-3 text-lg text-[#5C5A48]">Sidst opdateret: maj 2026 · Gælder fra første login</p>
          </div>
        </section>
        <section className="bg-white px-6 py-16">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">1. Accept af vilkår</h2>
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">2. Om tjenesten</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">3. Din konto</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">4. Betaling og abonnement</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">5. Ansvarsbegrænsning</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">6. Intellektuel ejendomsret</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#2C3020]">7. Lovvalg og værneting</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#5C5A48]">
