  ...
  return (
    <div className="flex w-full flex-col gap-6 p-6 md:p-8">
      ...
      <div className="border-b border-[#CBD5E8] pb-6">
        <Link href="/portal/support" className="text-sm font-semibold text-[#2952A3] hover:underline">
          ← Tilbage til Support & sager
        </Link>
        <h1 className="mt-4 text-2xl font-bold text-[#0A1628]">Ny sag</h1>
...
export default function PortalSupportNewPage() {
  return (
    <Suspense
      fallback={
        <div className="w-full p-6 text-sm text-[#2A4868] md:p-8">Indlæser…</div>
      }
    >
