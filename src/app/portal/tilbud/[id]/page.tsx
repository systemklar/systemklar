  ...
  return (
    <PortalLayout activeNav="tilbudsgenerator">
      ...
      <div className="mt-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#0D1F2D] md:text-3xl">Tilbud</h1>
          <p className="mt-2 text-xs text-[#4A8CB5]">Oprettet {formatDanishDateTime(quote.created_at)}</p>
      ...
      <form onSubmit={(e) => void handleSave(e)} className="mt-8 space-y-4">
        <div className="rounded-2xl border border-[#D0E8F5] bg-white p-6 shadow-sm">
          <label className="block text-sm font-medium text-[#2C4A5E]">Modtager-email</label>
          <input
            type="email"
        ...
        <div className="rounded-2xl border border-[#D0E8F5] bg-white p-6 shadow-sm">
          <label className="block text-sm font-medium text-[#2C4A5E]">Titel</label>
          <input
            value={title}
        ...
        <div className="rounded-2xl border border-[#D0E8F5] bg-white p-6 shadow-sm">
          <label className="block text-sm font-medium text-[#2C4A5E]">Indhold</label>
          <textarea
            value={content}
