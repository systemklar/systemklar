                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-base font-semibold text-[#0D1F2D]">
                        ...
                        {member.id === session?.userId ? <span className="text-xs text-[#4A8CB5]">(dig)</span> : null}
                      </p>
          ...
          <div className="w-full max-w-md rounded-2xl border border-sky-100 bg-white p-6 shadow-xl">
            ...
            <form className="space-y-4" onSubmit={(e) => void handleInvite(e)}>
              ...
              <div className="flex justify-end gap-2">
                ...
                <button type="submit" disabled={savingInvite} className="rounded-full bg-[#0A6EBD] px-5 py-2 text-sm font-semibold text-white hover:bg-[#0859A0] disabled:opacity-60">
