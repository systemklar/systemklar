      ...
      <main>
        <section className="bg-[#E8EEFC] py-20">
          <div className="mx-auto max-w-3xl px-6 text-center">
            <h1 className="text-4xl font-bold text-[#0A1628]">Privatlivspolitik</h1>
            <p className="mt-3 text-lg text-[#2A4868]">Sidst opdateret: maj 2026</p>
          </div>
        </section>
        <section className="bg-white px-6 py-16">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">1. Hvem er vi?</h2>
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">2. Hvilke oplysninger indsamler vi?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">3. Hvorfor behandler vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">Vi behandler dine oplysninger for at:</p>
            <ul className="mb-4 list-disc space-y-1 pl-5 text-sm text-[#2A4868]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">4. Deler vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">5. Hvor længe gemmer vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">6. Dine rettigheder</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">Du har ret til at:</p>
            <ul className="mb-4 list-disc space-y-1 pl-5 text-sm text-[#2A4868]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0A1628]">7. Kontakt</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2A4868]">
