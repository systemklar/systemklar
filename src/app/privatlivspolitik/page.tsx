      ...
      <main>
        <section className="bg-[#F0F7FF] py-20">
          <div className="mx-auto max-w-3xl px-6 text-center">
            <h1 className="text-4xl font-bold text-[#0D1F2D]">Privatlivspolitik</h1>
            <p className="mt-3 text-lg text-[#2C4A5E]">Sidst opdateret: maj 2026</p>
          </div>
        </section>
        <section className="bg-white px-6 py-16">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">1. Hvem er vi?</h2>
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">2. Hvilke oplysninger indsamler vi?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">3. Hvorfor behandler vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">Vi behandler dine oplysninger for at:</p>
            <ul className="mb-4 list-disc space-y-1 pl-5 text-sm text-[#2C4A5E]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">4. Deler vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">5. Hvor længe gemmer vi dine oplysninger?</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">6. Dine rettigheder</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">Du har ret til at:</p>
            <ul className="mb-4 list-disc space-y-1 pl-5 text-sm text-[#2C4A5E]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#0D1F2D]">7. Kontakt</h2>
            <p className="mb-4 text-sm leading-relaxed text-[#2C4A5E]">
